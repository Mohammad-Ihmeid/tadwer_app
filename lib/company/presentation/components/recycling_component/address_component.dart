...
class ShowAddressDialog extends StatelessWidget {
  ...
  static dynamic show(BuildContext context, {required Key key}) =>
      showAdaptiveDialog<dynamic>(
        context: context,
        useRootNavigator: false,
        barrierDismissible: false,
        builder: (_) => ShowAddressDialog(key: key),
      ).then((_) => FocusScope.of(context).requestFocus(FocusNode()));

  static void hide(BuildContext context) => Navigator.pop(context);

  ShowAddressDialog({required Key key}) : super(key: key);
              ...
              return Scaffold(
                ...
                body: SafeArea(
                  child: Center(
                    child: Container(
                      margin:
                          const EdgeInsets.symmetric(horizontal: AppMargin.m8),
                      padding: const EdgeInsets.all(AppPadding.p8),
                      decoration: BoxDecoration(
                        color: ColorManager.gray,
                        borderRadius:
                          ...
                          child: Column(
                            ...
                            children: [
                              Align(
                                alignment: Alignment.topLeft,
                                child: GestureDetector(
                                  onTap: () => ShowAddressDialog.hide(context),
                                  child: Container(
                                    color: Colors.transparent,
                                    child: Icon(
                                      Icons.close,
